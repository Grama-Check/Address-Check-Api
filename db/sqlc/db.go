...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getPersonStmt, err = db.PrepareContext(ctx, getPerson); err != nil {
		return nil, fmt.Errorf("error preparing query GetPerson: %w", err)
	}
	return &q, nil
}
...
func (q *Queries) Close() error {
	...
	if q.getPersonStmt != nil {
		if cerr := q.getPersonStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getPersonStmt: %w", cerr)
		}
	}
	return err
}
